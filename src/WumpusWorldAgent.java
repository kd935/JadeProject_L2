...
public class WumpusWorldAgent extends Agent {
    ...
    final static class Constants {
        ...
        static final String INITIAL_WUMPUS_CAVE = ". . . P " +
                                                  "W G . . " +
                                                  ". . . . " +
                                                  "S . P . ";
        ...
        static final String ADVICE_PROPOSAL = "Give me an advice, navigator.";
        static final String INFORMATION_PROPOSAL_NAVIGATOR = "Send me current game information.";
        static final String INFORMATION_PROPOSAL_SPELEOLOGIST = "I am sending you information: ";
        static final String ACTION_PROPOSAL1 = "I think you should ";
        static final String ACTION_PROPOSAL2 = "My advice is ";
        static final String ACTION_PROPOSAL3 = "Try this ";
